...
{
  /* <main className="w-full bg-sky-200 mt-24">
<div className={`w-full flex justify-between border-4 border-${theme} rounded-lg`}>
  <input type={"search"} className="w-full bg-[url('./assets/BackImage.png/')] p-5" />
  <span className={`rounded-2xl bg-[${theme}] p-2 m-2 border border-gray-300  shadow-xl`}>
    <svg
      width="20"
      height="20"
      viewBox="0 0 20 20"
