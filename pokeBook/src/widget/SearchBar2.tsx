  ...
  return (
    <main className="w-[20%] mt-4">
      <div className="flex w-full space-x-1 border rounded-l-full rounded-r-full shadow-lg">
        ...
        <input className="font-sans w-full h-12 bg-[url('./assets/BackImage.png/')] pl-5 rounded-r-full cursor-default" type="search" placeholder="Enter pokemon name"/>
      </div>
    </main>
  );
}
